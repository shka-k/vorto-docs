---
title: "Install Vorto with mise, Homebrew, a prebuilt binary, or from source"
sidebarTitle: "Installation"
description: "Install Vorto with mise or Homebrew — both ship with tree-sitter grammars embedded, so highlighting works on first launch. Or download a prebuilt binary, or build from crates.io or source. Verify the binary before opening your first file."
---
