...
- **Signin modal.** Copilot signin now opens the verification URL in your OS browser and shows a centered modal with the user code that stays visible while you authenticate. A new `:copilot code` subcommand re-shows the modal and re-copies the code if it gets lost. See [Copilot](/editing/copilot).
