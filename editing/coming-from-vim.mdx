...
description: "How your Vim muscle memory maps to Vorto — which motions, operators, and text objects work the same, what Vorto adds out of the box, and what isn't there yet."
---
